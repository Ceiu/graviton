...
public class ProductLink extends GraphLink<ProductLink, ProductNode, ProductNode> {
    private static final Logger LOG = Logger.getLogger(ProductLink.class);
    ...
    public ProductLink(ProductNode parent, ProductNode child, String type) {
        super(parent, child);
    ...
    public ProductLink setLocalLinkPresence(boolean present) {
    ...
    public ProductLink setExternalLinkPresence(boolean present) {
    ...
    public String toString() {
        return String.format("ProductLink [%s => %s]", this.getParentNode(), this.getChildNode());
    }
